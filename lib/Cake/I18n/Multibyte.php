...
class Multibyte
{
    ...
    protected static function _find($char, $type = 'lower')
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            } else if ($type === 'upper' && static::$_caseFold[static::$_table][$i][$type] === $char) {
                $found[] = static::$_caseFold[static::$_table][$i];
            }
        }
        return $found;
