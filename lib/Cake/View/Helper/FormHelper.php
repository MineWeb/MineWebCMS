...
class FormHelper extends AppHelper
{
    ...
    protected function _introspectModel($model, $key, $field = null)
    {
        ...
        if ($key === 'fields') {
            ...
            } else if (isset($this->fieldset[$model]['fields'][$field])) {
        ...
        } else if ($key === 'errors' && isset($this->validationErrors[$model])) {
            return $this->validationErrors[$model];
        }
    ...
    protected function _getModel($model)
    {
        ...
        } else if (isset($this->request->params['models'][$model])) {
        ...
        } else if (ClassRegistry::isKeySet($this->defaultModel)) {
    ...
    protected function _magicOptions($options)
    {
        ...
        if (isset($options['options'])) {
            $options['type'] = 'select';
        } else if (in_array($fieldKey, ['psword', 'passwd', 'password'])) {
            $options['type'] = 'password';
        } else if (in_array($fieldKey, ['tel', 'telephone', 'phone'])) {
            $options['type'] = 'tel';
        } else if ($fieldKey === 'email') {
            $options['type'] = 'email';
        } else if (isset($options['checked'])) {
            $options['type'] = 'checkbox';
        } else if ($fieldDef = $this->_introspectModel($modelKey, 'fields', $fieldKey)) {
            $type = $fieldDef['type'];
    ...
    protected function _inputLabel($fieldName, $label, $options)
    {
        ...
        if ($options['type'] === 'date' || $options['type'] === 'datetime') {
            ...
            if (array_key_exists('dateFormat', $options) &&
                ...
                $firstInput = 'H';
            } else if (!empty($options['dateFormat'])) {
    ...
    protected function _secure($lock, $field = null, $value = null)
    {
        ...
        if ($lock) {
            if (!in_array($field, $this->fields)) {
                ...
                } else if (isset($this->fields[$field]) && $value === null) {
    ...
    protected function _generateOptions($name, $options = [])
    {
        ...
        switch ($name) {
            ...
            case 'year':
                ...
                } else if (!empty($options['value']) && (int)$options['value'] > $max) {
            ...
            if ($name !== null) {
                ...
                if ($showParents || (!in_array($title, $parents))) {
                    ...
                    if ($attributes['style'] === 'checkbox') {
                        ...
                        } else if ($attributes['class'] === 'form-error') {
    ...
    public function year($fieldName, $minYear = null, $maxYear = null, $attributes = [])
    {
        ...
        if ((empty($attributes['value']) || $attributes['value'] === true) && $value = $this->value($fieldName)) {
            if (is_array($value)) {
                ...
                if (empty($value)) {
                    ...
                    } else if (!$attributes['empty'] && $maxYear && !$attributes['value']) {
        ...
        } else if ($attributes['value'] === false) {
            $attributes['value'] = null;
        }
    ...
    public function create($model = null, $options = [])
    {
        ...
        } else if (empty($model) && empty($this->request->params['models'])) {
            $model = false;
        }
        ...
        } else if (empty($options['url']) || is_array($options['url'])) {
            if (empty($options['url']['controller'])) {
                if (!empty($model)) {
                    $options['url']['controller'] = Inflector::underscore(Inflector::pluralize($model));
                } else if (!empty($this->request->params['controller'])) {
