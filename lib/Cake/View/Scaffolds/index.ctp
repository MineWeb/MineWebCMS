...
<div class="<?php echo $pluralVar; ?> index">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        foreach (${$pluralVar} as ${$singularVar}):
            ...
            echo $this->Html->link(__d('cake', 'View'), ['action' => 'view', ${$singularVar}[$modelClass][$primaryKey]]);
            echo ' ' . $this->Html->link(__d('cake', 'Edit'), ['action' => 'edit', ${$singularVar}[$modelClass][$primaryKey]]);
    ...
    <div class="paging">
        <?php
        echo $this->Paginator->prev('< ' . __d('cake', 'previous'), [], null, ['class' => 'prev disabled']);
        echo $this->Paginator->numbers(['separator' => '']);
        echo $this->Paginator->next(__d('cake', 'next') . ' >', [], null, ['class' => 'next disabled']);
        ?>
    </div>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d('cake', 'New %s', $singularHumanName), ['action' => 'add']); ?></li>
        <?php
        $done = [];
