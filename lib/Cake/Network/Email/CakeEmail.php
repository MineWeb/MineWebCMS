...
class CakeEmail
{
    ...
    public function __construct($config = null)
    {
        ...
        if ($config) {
            $this->config($config);
        } else if (config('email') && class_exists($this->_configClass)) {
    ...
    public function transportClass()
    {
        ...
        } else if (!method_exists($transportClassname, 'send')) {
    ...
    public static function deliver($to = null, $subject = null, $message = null, $transportConfig = 'fast', $send = true)
    {
        ...
        if (is_array($message)) {
            ...
            $message = null;
        } else if ($message === null && array_key_exists('message', $config = $instance->config())) {
    ...
    protected function _validateEmail($email, $context)
    {
        ...
        } else if (preg_match($this->_emailPattern, $email)) {
            return;
        }
        if ($email == '') {
