...
class TranslateBehavior extends ModelBehavior
{
    ...
    public function translateModel(Model $Model)
    {
        ...
        } else if (empty($Model->translateTable) && empty($Model->translateModel)) {
    ...
    protected function _removeField(Model $Model, $field)
    {
        ...
        } else if (in_array($field, $this->settings[$Model->alias])) {
        ...
        } else if (in_array($field, $this->runtime[$Model->alias]['fields'])) {
