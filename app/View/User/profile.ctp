        ...
        <div class="panel-body">
            ...
            <div id="twoFactorAuthValid" class="text-center" style="display: none;">
                ...
                <form class="form-horizontal" method="POST" data-ajax="true"
                      action="<?= $this->Html->url(['admin' => false, 'controller' => 'Authentification', 'action' => 'validEnable']) ?>"
            ...
            <script type="text/javascript">
                $('#toggleTwoFactorAuth').on('click', function (e) {
                    ...
                    // request to server
                    if (!status) { // enable
                        $.get('<?= $this->Html->url(['controller' => 'Authentification', 'action' => 'generateSecret']) ?>', function (data) {
                            // add qrcode
                        ...
                        $.get('<?= $this->Html->url(['controller' => 'Authentification', 'action' => 'disable']) ?>', function (data) {
                            // edit display
            ...
            <form method="post" class="form-inline" data-ajax="true"
                  action="<?= $this->Html->url(['plugin' => null, 'controller' => 'user', 'action' => 'change_pw']) ?>">
            ...
            <?php if ($Permissions->can('EDIT_HIS_EMAIL')) { ?>
                ...
                <form method="post" class="form-inline" data-ajax="true"
                      action="<?= $this->Html->url(['plugin' => null, 'controller' => 'user', 'action' => 'change_email']) ?>">
                    <div class="form-group">
            ...
            <?php if ($shop_active) { ?>
                ...
                <form method="post" class="form-inline" data-ajax="true"
                      action="<?= $this->Html->url(['plugin' => 'shop', 'controller' => 'payment', 'action' => 'transfer_points']) ?>">
                    <div class="form-group">
            ...
            <?php if ($can_skin) { ?>
                ...
                <form class="form-inline" method="post" id="skin" method="post" data-ajax="true"
                      data-upload-image="true" action="<?= $this->Html->url(['action' => 'uploadSkin']) ?>">
                    <div class="form-group">
            ...
            <?php if ($can_cape) { ?>
                ...
                <form class="form-inline" method="post" id="cape" method="post" data-ajax="true"
                      data-upload-image="true" action="<?= $this->Html->url(['action' => 'uploadCape']) ?>">
                    <div class="form-group">
                        <label><?= $Lang->get('FORM__BROWSE') ?></label>
                        <input name="image" type="file">
                    </div>
