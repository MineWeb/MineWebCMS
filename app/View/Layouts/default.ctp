                    ...
                    <li class="button">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php if ($isConnected) { ?>
                                    <li>
                                        <a href="<?= $this->Html->url(['controller' => 'profile', 'action' => 'index', 'plugin' => false]) ?>"><?= $Lang->get('USER__PROFILE') ?></a>
                                    </li>
                                    ...
                                    <?php if ($Permissions->can('ACCESS_DASHBOARD')) { ?>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="<?= $this->Html->url(['controller' => 'admin', 'action' => 'index', 'plugin' => false, 'admin' => true]) ?>"><?= $Lang->get('GLOBAL__ADMIN_PANEL') ?></a>
                                        </li>
                                    <?php } ?>
                                    <li class="divider"></li>
                                    <li>
