...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<div class="top-bar">
			<h3><i class="icon-cog"></i> <?= $Lang->get('ADD_PAGE') ?></h3>
		</div>
...
<script type="text/javascript">
    $("#news_add").submit(function( event ) {
        ...
        $.post("<?= $this->Html->url(array('controller' => 'pages', 'action' => 'add_ajax', 'admin' => true)) ?>", { title : title, slug : slug, content : content }, function(data) {
          	data2 = data.split("|");
