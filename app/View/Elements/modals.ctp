  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="login-two-factor-auth" style="display:none;" method="POST" data-ajax="true" action="<?= $this->Html->url(array('admin' => false, 'controller' => 'UserSecret', 'action' => 'validLogin')) ?>" data-redirect-url="?">
            <div class="modal-body">
                <div class="ajax-msg"></div>
                <div class="form-group">
