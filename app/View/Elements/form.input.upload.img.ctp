<div class="form-group">
  ...
  <div id="image_preview">
      <div class="thumbnail">
          ...
          <?= (isset($img)) ? '<img src="'.$img.'" class="pull-left" width="150" style="margin-top:10px;">' : $this->Html->image('form_img.png', array('class' => 'pull-left', 'width' => '150', 'style' => 'margin-top:10px;')) ?>
