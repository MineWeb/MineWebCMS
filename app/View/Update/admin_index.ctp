                    ...
                    <div style="text-align: center;">
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-warning"
                               href="<?= $this->Html->url(['action' => 'clear_cache']) ?>"><?= $Lang->get('UPDATE__CLEAR_CACHE') ?></a>
                            <a href="<?= $this->Html->url(['action' => 'check']) ?>"
...
<script>
    function callMAJ(updaterUpdated) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= $this->Html->url(['action' => 'update']) ?>/' + updaterUpdated,
            data: inputs,
            dataType: 'JSON',
            success: function (data) {
                ...
                if (data.statut == "success") {
                    ...
                    $('#update').remove();
                    window.location = '<?= $this->Html->url(['action' => 'clear_cache']) ?>';
    ...
    $('#forced_updates').on('change', function (e) {
        ...
        $.get('<?= $this->Html->url(['action' => 'switchForceUpdates']) ?>');
