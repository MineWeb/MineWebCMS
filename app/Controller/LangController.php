	...
	function admin_index() {
		if($this->isConnected AND $this->User->isAdmin()) {
			...
			if($this->request->is('post')) {
				if($this->Configuration->get('lang') == "fr") {
					$this->request->data['COPYRIGHT'] = "Tous droits réservés - 2015 <span class=\"pull-right\">Propulsé par <a href=\"http://mineweb.org\">mineweb.org</a></span>";
					...
					$this->request->data['COPYRIGHT'] = "";
					$this->request->data['FOOTER_ADMIN'] = "";
				}
