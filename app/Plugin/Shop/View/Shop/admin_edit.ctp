  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form action="<?= $this->Html->url(array('controller' => 'shop', 'action' => 'edit_ajax')) ?>" method="post">
            ...
            <div class="form-group">
              ...
              <div class="radio">
                <label>
                  <input name="timedCommand" type="radio" value="true"<?= ($item['timedCommand']) ? ' checked=""' : ''; ?>> <?= $Lang->get('ENABLED') ?>
                </label>
                <br>
                <label>
                  <input name="timedCommand" type="radio" value="false"<?= (!$item['timedCommand']) ? ' checked=""' : ''; ?>> <?= $Lang->get('DISABLED') ?>
                </label>
              </div>
