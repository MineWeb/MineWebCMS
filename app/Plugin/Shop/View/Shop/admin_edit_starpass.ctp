...
<div class="row-fluid">
	...
	<div class="span12">
		...
		<div class="top-bar">
			<h3><i class="icon-cog"></i> <?= $Lang->get('EDIT_OFFER_STARPASS') ?></h3>
		</div>
...
<script type="text/javascript">
    $("#edit_starpass").submit(function( event ) {
        ...
        $.post("<?= $this->Html->url(array('controller' => 'shop', 'action' => 'edit_starpass_ajax/'.$id, 'admin' => true)) ?>", { name : name, idd : idd, idp : idp, money : money }, function(data) {
          	data2 = data.split("|");
